"""
    This model represent a continuous period of time when the library is open usually a term or semester.
    Each period has a: Staring date
                       Ending date
                       Status ( whether open or closed )
                       period_id ( LP/01/2023 ) This is a library period (LP) followed by term and then year
    ...
    - When a new period is started, each member is supposed to activate before having access to library services.
